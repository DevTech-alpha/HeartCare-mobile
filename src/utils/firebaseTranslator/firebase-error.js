export const firebaseErrorsPortugues = {
  ...
  "auth/invalid-action-code":
    "O código de ação é inválido. Isso pode ocorrer se o código estiver malformado ou já tiver sido utilizado.",
  "auth/user-disabled":
  ...
  "auth/missing-email": "O endereço de e-mail não foi fornecido.",
  "auth/operation-not-allowed":
    "O tipo de conta associado a esta credencial ainda não está ativado.",
  "auth/account-exists-with-different-credential":
    "E-mail já associado a outra conta.",
  "auth/auth-domain-config-required":
    "A configuração para autenticação não foi fornecida.",
  "auth/credential-already-in-use":
    "Já existe uma conta associada a esta credencial.",
  "auth/operation-not-supported-in-this-environment":
    "Esta operação não é suportada no ambiente atual. Verifique se deve ser HTTP ou HTTPS.",
  "auth/timeout":
    "Tempo de resposta excedido. O domínio pode não estar autorizado para realizar operações.",
  "auth/missing-android-pkg-name":
    "Deve ser fornecido um nome de pacote para a instalação do aplicativo Android.",
  "auth/missing-continue-uri":
    "A próxima URL deve ser fornecida na solicitação.",
  "auth/missing-ios-bundle-id":
    "Deve ser fornecido um nome de pacote para a instalação do aplicativo iOS.",
  "auth/invalid-continue-uri":
    "A próxima URL fornecida na solicitação é inválida.",
  "auth/unauthorized-continue-uri":
    "O domínio da próxima URL não está autorizado.",
  ...
  "auth/too-many-requests":
    "As solicitações foram bloqueadas devido a atividades incomuns. Tente novamente depois de algum tempo.",
  "auth/web-storage-unsupported":
    "O navegador não suporta armazenamento ou o usuário desativou este recurso.",
  "auth/invalid-claims":

export interface Language {
  TEXTO: {
    ...
    PROMPT: string;
    PROMPT2: string;
    EDITAR_MEDICAO: string;
    CRIADO_COM_SUCESSO: string;
    CONFIRMA: string;
    SAIR_SESSAO: string;
    CANCELAR_SESSAO: string;
    ALERT_MEDI: string;
    APAGAR_MEDI: string;
    EMAIL_REC: string;
    SENHA_NAO_CORRESPONDE: string;
    REGISTRO_SUCESSO: string;
    ALTERADO_SUCESSO: string;
    APAGAR_PUBLICACAO: string;
    APAGADO_SUCESSO: string;
